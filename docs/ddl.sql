...
CREATE TABLE pipeline_task (
    ...
    task_payload LONGTEXT NULL,
    publication_status VARCHAR(20) NOT NULL DEFAULT '',
    publication_attempt_count INT NOT NULL DEFAULT 0,
    publication_claimed_at TIMESTAMP(3) NULL,
    ...
    INDEX idx_pipeline_publication_status (publication_status),
