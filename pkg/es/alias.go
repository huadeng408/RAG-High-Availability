...
func createEvidenceIndexIfNotExists(indexName string) error {
	...
	mapping := `{"mappings":{"properties":{"evidence_id":{"type":"keyword"},"document_version":{"type":"keyword"},"modality":{"type":"keyword"},"page_number":{"type":"integer"},"slide_number":{"type":"integer"},"sheet_name":{"type":"keyword"},"text_content":{"type":"text"},"bbox":{"type":"object"},"owner_id":{"type":"keyword"},"org_tag":{"type":"keyword"},"is_public":{"type":"boolean"}}}}`
